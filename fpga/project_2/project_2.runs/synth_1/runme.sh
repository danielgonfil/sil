...
HD_PWD='C:/Users/Administrator/Desktop/project_2/project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log min_cfg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source min_cfg.tcl
