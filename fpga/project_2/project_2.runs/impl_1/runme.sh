...
HD_PWD='C:/Users/Administrator/Desktop/project_2/project_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log min_cfg.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source min_cfg.tcl -notrace
