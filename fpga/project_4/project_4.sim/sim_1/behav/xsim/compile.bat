...
REM
REM Generated by Vivado on Thu Aug 14 17:44:51 +0200 2025
...
echo "xvlog --incr --relax -L uvm -prj tb_led_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_led_vlog.prj -log xvlog.log
